...
pub use decoder::{
    ...
    DecodeProfile, DecodeReport, DecodeStage, DecoderSession, DecodedMessage, StageDecodeReport,
    debug_candidate_pcm, debug_candidate_truth_wav_file, debug_candidate_wav_file, decode_pcm,
    decode_wav_file,
};
pub use encode::{
